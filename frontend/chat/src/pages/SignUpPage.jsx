...
const SignUpPage = () => {
  ...
  const validateForm = () =>{
    ...
    if(formData.password.length<6)return toast.error('Password atleast 6 character')
  ...
  return (
<div className='flex flex-col justify-center items-center p-6 sm:p-12 h-[88vh]'>
